...
for batch in batches:
    im_path = "vehicles/batch" + str(batch) + "_og"
    csv_path = "vehicles/batch"+ str(batch) + "_via_region_data.csv"

    raw_dat = pd.read_csv(csv_path)
    ...
    formatted.to_csv("vehicles/batch" + str(batch) + "_formatted_og.csv")
